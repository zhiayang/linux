...
static const struct axiadc_chip_info axiadc_chip_info_tbl[] = {
	...
	[ID_ADRV9009_X4] = {
		...
		.channel[6] = AIM_CHAN(3, IIO_MOD_I, 6, 16, 'S'),
		.channel[7] = AIM_CHAN(3, IIO_MOD_Q, 7, 16, 'S'),
		.channel[8] = AIM_CHAN(4, IIO_MOD_I, 0, 16, 'S'),
		.channel[9] = AIM_CHAN(4, IIO_MOD_Q, 1, 16, 'S'),
		.channel[10] = AIM_CHAN(5, IIO_MOD_I, 2, 16, 'S'),
		.channel[11] = AIM_CHAN(5, IIO_MOD_Q, 3, 16, 'S'),
		.channel[12] = AIM_CHAN(6, IIO_MOD_I, 4, 16, 'S'),
		.channel[13] = AIM_CHAN(6, IIO_MOD_Q, 5, 16, 'S'),
		.channel[14] = AIM_CHAN(7, IIO_MOD_I, 6, 16, 'S'),
		.channel[15] = AIM_CHAN(7, IIO_MOD_Q, 7, 16, 'S'),
	},
	[ID_ADRV90081] = {
		.name = "ADRV9008-1",
		.max_rate = 245760000,
