/**
 * \file fpga9001_bf_axi_tdd_debug.c Automatically generated file with generator ver 0.0.1.0.
 *
...
#include "./../../private/include/fpga9001_bf_axi_tdd_debug.h"
#include "./../../private/include/fpga9001_bf_hal.h"
#include "adi_common_error.h"

/**
 * \brief An 8-bit test pattern
 * 
 * \dep_begin
 ...
 *  Parameter is of type ::fpga9001_BfAxiTddDebugChanAddr_e.
                                               ...
                                               uint8_t bfValue)
{
        ...
        (bfValue > 255U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         bfValue,
                         "Invalid fpga9001_AxiTddDebugDebugPatternBfSet parameter");
    ...
    /* Base Address check */
    if ((baseAddr != FPGA9001_BF_AXI_ADRV9001_TDD_DEBUG_0))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ADI_COMMON_ERRSRC_DEVICEBF, 
                         ADI_COMMON_ERR_INV_PARAM, 
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9001_AxiTddDebugDebugPatternBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
    ...
    /* Write to Field */
    recoveryAction = fpga9001_BfFieldWrite(device, (baseAddr + 0x4), (uint32_t)bfValue, 0xFF00, 0x8);
    ADI_ERROR_RETURN(device->common.error.newAction);
                                               ...
                                               uint8_t *bfValue)
{
    ...
    if ((baseAddr != FPGA9001_BF_AXI_ADRV9001_TDD_DEBUG_0))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9001_AxiTddDebugDebugPatternBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9001_BITFIELD_ADDR_CHECK */ 
    ...
    /* Read Field */
    recoveryAction = fpga9001_BfFieldRead(device, (baseAddr + 0x4), &rxBfData[0], 0xFF00, 0xC8);
    ADI_ERROR_RETURN(device->common.error.newAction);
...
/**
 * \brief Select for debug output multiplexer. Options are: 111: debug_cnt; 110: debug_6; 101: debug_5; 100: debug_4; 011: debug_3; 010: debug_2; 001: debug_1; 000: debug_pattern
 * 
 * \dep_begin
 * \dep{device->common.devHalInfo}
 * \dep_end
                                           ...
                                           uint8_t bfValue)
{
        ...
        (bfValue > 7U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9001_AxiTddDebugDebugSelBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9001_BITFIELD_VALUE_CHECK */
    ...
    if ((baseAddr != FPGA9001_BF_AXI_ADRV9001_TDD_DEBUG_0))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9001_AxiTddDebugDebugSelBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9001_BITFIELD_ADDR_CHECK */ 
    ...
    /* Write to Field */
    recoveryAction = fpga9001_BfFieldWrite(device, (baseAddr + 0x4), (uint32_t)bfValue, 0x7, 0x0);
    ADI_ERROR_RETURN(device->common.error.newAction);
    recoveryAction = fpga9001_BfWriteCacheFlush(device);
    ADI_ERROR_RETURN(device->common.error.newAction);
                                           ...
                                           uint8_t *bfValue)
{
    ...
    if ((baseAddr != FPGA9001_BF_AXI_ADRV9001_TDD_DEBUG_0))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9001_AxiTddDebugDebugSelBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9001_BITFIELD_ADDR_CHECK */ 
    ...
    /* Read Field */
    recoveryAction = fpga9001_BfFieldRead(device, (baseAddr + 0x4), &rxBfData[0], 0x7, 0xC0);
    ADI_ERROR_RETURN(device->common.error.newAction);
    recoveryAction = fpga9001_BfReadAssembleData(device, &rxBfData[0x0], 0x1, &data);
    ADI_ERROR_RETURN(device->common.error.newAction);
                                             ...
                                             uint32_t *bfValue)
{
    ...
    if ((baseAddr != FPGA9001_BF_AXI_ADRV9001_TDD_DEBUG_0))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9001_AxiTddDebugInstanceIdBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9001_BITFIELD_ADDR_CHECK */ 
...
/*  EOF: fpga9001_bf_axi_tdd_debug.c */
