...
int32_t adrv9001_NvsRegmapTxTxAlgLolPngenClkEnBfSet(adi_adrv9001_Device_t *device, 
                                                    adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                    uint8_t bfValue);
int32_t adrv9001_NvsRegmapTxTxAlgLolPngenClkEnBfGet(adi_adrv9001_Device_t *device, 
                                                    adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                    uint8_t *bfValue);


int32_t adrv9001_NvsRegmapTxTxAlgLolPngenClkSelBfSet(adi_adrv9001_Device_t *device, 
                                                     adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                     uint8_t bfValue);
int32_t adrv9001_NvsRegmapTxTxAlgLolPngenClkSelBfGet(adi_adrv9001_Device_t *device, 
                                                     adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                     uint8_t *bfValue);
...
int32_t adrv9001_NvsRegmapTxTxAlgNcoClkEnBfSet(adi_adrv9001_Device_t *device, 
                                               adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                               uint8_t bfValue);
int32_t adrv9001_NvsRegmapTxTxAlgNcoClkEnBfGet(adi_adrv9001_Device_t *device, 
                                               adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                               uint8_t *bfValue);


int32_t adrv9001_NvsRegmapTxTxAlgNcoMcsClkEnBfSet(adi_adrv9001_Device_t *device, 
                                                  adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                  uint8_t bfValue);
int32_t adrv9001_NvsRegmapTxTxAlgNcoMcsClkEnBfGet(adi_adrv9001_Device_t *device, 
                                                  adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                  uint8_t *bfValue);


int32_t adrv9001_NvsRegmapTxTxAlgNcoMcsClkSelBfSet(adi_adrv9001_Device_t *device, 
                                                   adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                   uint8_t bfValue);
int32_t adrv9001_NvsRegmapTxTxAlgNcoMcsClkSelBfGet(adi_adrv9001_Device_t *device, 
                                                   adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                   uint8_t *bfValue);


int32_t adrv9001_NvsRegmapTxTxAlgObsMcpfir13tapsBClkEnBfSet(adi_adrv9001_Device_t *device, 
                                                            adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                            uint8_t bfValue);
int32_t adrv9001_NvsRegmapTxTxAlgObsMcpfir13tapsBClkEnBfGet(adi_adrv9001_Device_t *device, 
                                                            adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                            uint8_t *bfValue);
...
int32_t adrv9001_NvsRegmapTxTxGdcalGdcalWindowSizeBfSet(adi_adrv9001_Device_t *device, 
                                                        adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                        uint8_t bfValue);
int32_t adrv9001_NvsRegmapTxTxGdcalGdcalWindowSizeBfGet(adi_adrv9001_Device_t *device, 
                                                        adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                        uint8_t *bfValue);


int32_t adrv9001_NvsRegmapTxTxGdcalPowerThresholdBfSet(adi_adrv9001_Device_t *device, 
                                                       adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                       uint8_t bfValue);
int32_t adrv9001_NvsRegmapTxTxGdcalPowerThresholdBfGet(adi_adrv9001_Device_t *device, 
                                                       adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                       uint8_t *bfValue);
...
int32_t adrv9001_NvsRegmapTxTxGdcalThresholdShiftBfSet(adi_adrv9001_Device_t *device, 
                                                       adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                       uint8_t bfValue);
int32_t adrv9001_NvsRegmapTxTxGdcalThresholdShiftBfGet(adi_adrv9001_Device_t *device, 
                                                       adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                       uint8_t *bfValue);
...
int32_t adrv9001_NvsRegmapTxTxMagcompPfir13409bSwResetBfSet(adi_adrv9001_Device_t *device, 
                                                            adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                            uint8_t bfValue);
int32_t adrv9001_NvsRegmapTxTxMagcompPfir13409bSwResetBfGet(adi_adrv9001_Device_t *device, 
                                                            adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                            uint8_t *bfValue);


int32_t adrv9001_NvsRegmapTxTxMagcompPfir21SwResetBfSet(adi_adrv9001_Device_t *device, 
                                                        adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                        uint8_t bfValue);
int32_t adrv9001_NvsRegmapTxTxMagcompPfir21SwResetBfGet(adi_adrv9001_Device_t *device, 
                                                        adrv9001_BfNvsRegmapTxChanAddr_e baseAddr, 
                                                        uint8_t *bfValue);
