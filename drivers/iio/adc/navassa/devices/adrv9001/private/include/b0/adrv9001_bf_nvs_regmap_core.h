...
int32_t adrv9001_NvsRegmapCoreArmClkSelResetBfSet(adi_adrv9001_Device_t *device, 
                                                  adrv9001_BfNvsRegmapCoreChanAddr_e baseAddr, 
                                                  uint8_t bfValue);
int32_t adrv9001_NvsRegmapCoreArmClkSelResetBfGet(adi_adrv9001_Device_t *device, 
                                                  adrv9001_BfNvsRegmapCoreChanAddr_e baseAddr, 
                                                  uint8_t *bfValue);
...
int32_t adrv9001_NvsRegmapCoreArmCmdStatusBfGet(adi_adrv9001_Device_t *device, 
                                                adrv9001_BfNvsRegmapCoreChanAddr_e baseAddr, 
                                                int64_t *bfValue);


int32_t adrv9001_NvsRegmapCoreArmCmdStatus2BfSet(adi_adrv9001_Device_t *device, 
                                                 adrv9001_BfNvsRegmapCoreChanAddr_e baseAddr, 
                                                 uint64_t bfValue);
int32_t adrv9001_NvsRegmapCoreArmCmdStatus2BfGet(adi_adrv9001_Device_t *device, 
                                                 adrv9001_BfNvsRegmapCoreChanAddr_e baseAddr, 
                                                 uint64_t *bfValue);
...
int32_t adrv9001_NvsRegmapCoreArmDpDriveCaptureDoneBfGet(adi_adrv9001_Device_t *device, 
                                                         adrv9001_BfNvsRegmapCoreChanAddr_e baseAddr, 
                                                         uint8_t *bfValue);
...
int32_t adrv9001_NvsRegmapCoreRxqecObsRdyGenEnableBfSet(adi_adrv9001_Device_t *device, 
                                                        adrv9001_BfNvsRegmapCoreChanAddr_e baseAddr, 
                                                        uint8_t bfValue);
int32_t adrv9001_NvsRegmapCoreRxqecObsRdyGenEnableBfGet(adi_adrv9001_Device_t *device, 
                                                        adrv9001_BfNvsRegmapCoreChanAddr_e baseAddr, 
                                                        uint8_t *bfValue);
