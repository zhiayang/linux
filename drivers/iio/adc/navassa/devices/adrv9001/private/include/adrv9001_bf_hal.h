...
#ifndef ADRV9001_BF_HAL_H_
#define ADRV9001_BF_HAL_H_
...
#include "adrv9001_bf_hal_types.h"
...
*
*/
int32_t adrv9001_BfWriteCacheEn(adi_adrv9001_Device_t *device, adrv9001_Bf_WrCache_State_e wrCacheState);
...
*
*/
int32_t adrv9001_BfReadCacheEn(adi_adrv9001_Device_t *device, adrv9001_Bf_RdCache_State_e rdCacheState);
...
* \param device Pointer to the ADRV9001 device data structure.
*
* \retval ADRV9001_ Recovery action for log reset
* \retval ADRV9001_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADRV9001_ACT_ERR_RESET_SPI Recovery action for SPI reset required
* \retval ADRV9001_ACT_NO_ACTION Function completed successfully, no action required
*
...
*
*/
int32_t adrv9001_BfByteWrite(adi_adrv9001_Device_t *device, uint16_t addr, uint8_t regVal);
...
*
*/
int32_t adrv9001_BfByteRead(adi_adrv9001_Device_t *device, uint16_t addr, uint8_t *regVal, uint8_t endOfBf);
...
* This value is used to shift the value so that it alligns with the location of the field within the register.
*
* \retval ADRV9001_ACT_WARN_RESET_LOG Recovery action for log reset
* \retval ADRV9001_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADRV9001_ACT_ERR_RESET_SPI Recovery action for SPI reset required
...
*
*/
int32_t adrv9001_BfFieldWrite(adi_adrv9001_Device_t *device, uint16_t addr, uint8_t  fieldVal, uint8_t mask, uint8_t startBit);
...
*
*/
int32_t adrv9001_BfFieldRead(adi_adrv9001_Device_t *device, uint16_t addr, uint8_t *fieldVal, uint8_t mask, uint8_t startBit);
...
*
*/
int32_t adrv9001_BfReadAssembleData(adi_adrv9001_Device_t *device, uint8_t *rxBfData, uint8_t numRdBfData, uint64_t *rdData);
...
*
*/
int32_t adrv9001_BfReadCacheFlush(adi_adrv9001_Device_t *device, uint64_t *rdData, uint16_t *numRxBitFields);
