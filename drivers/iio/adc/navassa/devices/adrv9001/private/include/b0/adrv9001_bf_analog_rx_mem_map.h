...
int32_t adrv9001_AnalogRxMemMapLb1feLocmBBfSet(adi_adrv9001_Device_t *device, 
                                               adrv9001_BfAnalogRxMemMapChanAddr_e baseAddr, 
                                               uint8_t bfValue);
int32_t adrv9001_AnalogRxMemMapLb1feLocmBBfGet(adi_adrv9001_Device_t *device, 
                                               adrv9001_BfAnalogRxMemMapChanAddr_e baseAddr, 
                                               uint8_t *bfValue);
...
int32_t adrv9001_AnalogRxMemMapOrx1feLocmBBfSet(adi_adrv9001_Device_t *device, 
                                                adrv9001_BfAnalogRxMemMapChanAddr_e baseAddr, 
                                                uint8_t bfValue);
int32_t adrv9001_AnalogRxMemMapOrx1feLocmBBfGet(adi_adrv9001_Device_t *device, 
                                                adrv9001_BfAnalogRxMemMapChanAddr_e baseAddr, 
                                                uint8_t *bfValue);
...
int32_t adrv9001_AnalogRxMemMapOrx2feLocmBBfSet(adi_adrv9001_Device_t *device, 
                                                adrv9001_BfAnalogRxMemMapChanAddr_e baseAddr, 
                                                uint8_t bfValue);
int32_t adrv9001_AnalogRxMemMapOrx2feLocmBBfGet(adi_adrv9001_Device_t *device, 
                                                adrv9001_BfAnalogRxMemMapChanAddr_e baseAddr, 
                                                uint8_t *bfValue);
