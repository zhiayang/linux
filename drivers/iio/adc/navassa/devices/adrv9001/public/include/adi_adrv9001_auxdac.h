 ...
 */
int32_t adi_adrv9001_AuxDac_Configure(adi_adrv9001_Device_t *adrv9001, adi_adrv9001_AuxDacs_e auxDac, bool enable);
 ...
 * \returns A code indicating success (ADI_COMMON_ACT_NO_ACTION) or the required action to recover
 */
int32_t adi_adrv9001_AuxDac_Inspect(adi_adrv9001_Device_t *adrv9001, adi_adrv9001_AuxDacs_e auxDac, bool *enabled);
 ...
 * \param[in] auxDacCode     The desired 12-bit DAC code to be written
 *
 * \returns A code indicating success (ADI_COMMON_ACT_NO_ACTION) or the required action to recover
 */
int32_t adi_adrv9001_AuxDac_Code_Set(adi_adrv9001_Device_t *adrv9001,
 ...
 * \param[out] auxDacCode    DAC code read from ADRV9001 device for the selected AuxDAC
 *
 * \returns A code indicating success (ADI_COMMON_ACT_NO_ACTION) or the required action to recover
 */
int32_t adi_adrv9001_AuxDac_Code_Get(adi_adrv9001_Device_t *adrv9001,
                                     adi_adrv9001_AuxDacs_e auxDac,
                                     uint16_t *auxDacCode);
