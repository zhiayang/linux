 ...
 * @cached_range:	Cached range coresponding to the selected offset
...
struct ad5766_state {
	...
	enum ad5766_voltage_range	cached_range;
...
static void ad5766_set_scalesavail(struct ad5766_state *st)
{
	int i;
	u8 realbits = st->chip_info->channels[0].scan_type.realbits;
	u64 scale;
...
=======
			AD5766_FULL_RESET_CODE);
>>>>>>> 35c42277d39b... iio: dac: ad5766: Add span support.
		if (ret < 0)
			return ret;
	}
...
{
	int i, ret;
	enum ad5766_voltage_range offset_idx = st->cached_range;
